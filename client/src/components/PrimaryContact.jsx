...
const PrimaryContact = () => {
  return (
    <div className="primary__contact">
          <Typography className='text-[20px] font-montserrat lg:text-[20px] text-[1rem] font-bold py-[2rem] lg:pb-2'>Primary Contact <span className="asterisk text-[#ff0000]">*</span></Typography>
